...
Bндекс организованный в виде би-дерева. Состоит из двух блоков: ветки для поиска и листья, которые хранят значения. Листья содержат все проиндексированные данные. [Подробнее об индексах](../8_Different/Index.md#би-дерево)
