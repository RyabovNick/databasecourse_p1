...
Select s.*, sh.*
FROM students s
LEFT JOIN stud_hobby sh on s.n_zach = sh.n_zach;
```
...
Select s.*, sh.*
FROM students s
RIGHT JOIN stud_hobby sh on s.n_zach = sh.n_zach;
```
...
Select s.*, sh.*
FROM students s
FULL OUTER JOIN stud_hobby sh on s.n_zach = sh.n_zach;
```
